...
const char *WINDOWTITLE = { "Keytime Animation Demo -- Robert Hudspeth" };
...
InitGraphics( void )
{
	...
	//KEYTIMES TO INTERPOLATE BETWEEN

	//KEYFRAME 0
	Xpos.AddTimeValue(0., 0.);
	Ypos.AddTimeValue(0., 0.);
	Zpos.AddTimeValue(0., 0.);

	//KEYFRAME 1
	Xpos.AddTimeValue(1., 500.);
	Ypos.AddTimeValue(1., 500.);
	Zpos.AddTimeValue(1., 0.);

	//KEYFRAME 2
	Xpos.AddTimeValue(2., 1000.);
	Ypos.AddTimeValue(2., 0.);
	Zpos.AddTimeValue(2., 0.);

	//KEYFRAME 3
	Xpos.AddTimeValue(3., 1000.);
	Ypos.AddTimeValue(3., 500.);
	Zpos.AddTimeValue(3., 500.);

	//KEYFRAME 4
	Xpos.AddTimeValue(4., 1000.);
	Ypos.AddTimeValue(4., 0.);
	Zpos.AddTimeValue(4., 1000.);

	//KEYFRAME 5
	Xpos.AddTimeValue(5., 500.);
	Ypos.AddTimeValue(5., 500.);
	Zpos.AddTimeValue(5., 1000.);

	//KEYFRAME 6
	Xpos.AddTimeValue(6., 0.);
	Ypos.AddTimeValue(6., 0.);
	Zpos.AddTimeValue(6., 1000.);

	//KEYFRAME 7
	Xpos.AddTimeValue(7., 0.);
	Ypos.AddTimeValue(7., 500.);
	Zpos.AddTimeValue(7., 500.);

	//KEYFRAME 8
	Xpos.AddTimeValue(8., 0.);
	Ypos.AddTimeValue(8., 0.);
	Zpos.AddTimeValue(8., 0.);
}
...
InitLists( void )
{
	...
	//KEYFRAME 1
	{
		float xpos = Xpos.GetValue(1.);
		float ypos = Ypos.GetValue(1.);
		float zpos = Zpos.GetValue(1.);
		glPushMatrix();
			glTranslatef(xpos, ypos, zpos);
			glCallList(ObjectList);
			glutWireTorus(RADIUS1, RADIUS2, 10, 10);
